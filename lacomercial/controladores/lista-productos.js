...
import { insertarPedidos, insertarDetallePedidos } from "../modelos/pedidos.js";
// Objetos del DOM
                ...
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="./imagenes/productos/${
                          producto.imagen ?? "nodisponible.png"
        ...
        producto.nombre
                        ...
                        <div class="card-footer ${
                          logueado ? "d-flex" : "d-none"
                            ...
                            <input type="hidden" class="idProducto" value="${
                              producto.id
                            }">                            
                        </div>
                    </div>
...
on(document, "click", ".btnEditar", (e) => {
  ...
  frmImagen.src = `./imagenes/productos/${
    producto.imagen ?? "nodisponible.png"
  }`;
...
on(document, "click", ".btnCarrito", async (e) => {
  ...
  if (!pedido) {
    ...
    try {
      ...
      if (response && response.success && response.pedido_id) {
